...
public class Ship1 : ShipParent
{
	protected override void Shoot()
	{
		GameObject gameObject = Object.Instantiate(bulletShot, shotPoint.position, shotPoint.rotation);
		GameObject gameObject2 = Object.Instantiate(bulletShot, shotPoint2.position, shotPoint2.rotation);
		GameObject gameObject3 = Object.Instantiate(bulletShot, shotPoint3.position, shotPoint3.rotation);
		GameObject gameObject4 = Object.Instantiate(bulletShot, shotPoint4.position, shotPoint4.rotation);
		GameObject gameObject5 = Object.Instantiate(bulletShot, shotPoint5.position, shotPoint5.rotation);
